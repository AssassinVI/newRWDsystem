  ...
  <style type="text/css">
    ...
    @media (max-width: 768px){
          ...
          #ver6_ph{position: fixed; bottom: 0; left: 42vw; width: 40px; height: 35px; }
          #ver6_ph span{ background-color: #000; border-radius: 100%; width: 34px; height: 33px; }
         ...
         .bottom_tool a span{ display: inline-block; width: 25px; height: 24px; background-color: rgba(0,0,0,0); border-radius: 4px; background-repeat: no-repeat; background-position: center;}
    ...
    <a target="_blank" href="https://www.google.com/maps/dir//<?php echo $map_txt;?>/@<?php echo $map_txt;?>,17z?hl=zh-TW" onclick="ga('send', 'event', 'google 導航', 'click', 'tool_bar')">
     ...
     <a target="_blank" href="<?php echo $line_txt;?>" onclick="ga('send', 'event', '加LINE或Line分享', 'click', 'tool_bar')">
      <span style="background-image: url(../../img/svg/block/line-block.svg); background-size: 75%; "></span>
   	 ...
   	 <a id="ver6_ph" href="tel:<?php echo $case['phone'];?>" onclick="ga('send', 'event', '撥打手機', 'click', 'tool_bar')">
   	 	<span style="background-image: url(../../img/svg/007-phone-receiver.svg); background-size: 46%; "></span>
   	 </a>
